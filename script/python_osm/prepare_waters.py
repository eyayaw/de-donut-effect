...
# define columns you want to keep (for each water)
...
# loop
for water in waters:
    # store data for all years and one water at the time
    all_files = []
    for year in years:
        # get files for waters (i.e. each city and year)
        path = join(data_path, water)
        ...
        # add source
        complete_data["source"] = str(water)
        
        # save data frame
        filename = water + "_germany_all_years.csv"
